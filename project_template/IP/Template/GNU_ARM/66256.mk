...
#/*---------------------------------------------------------------------------------------------------------*/
CHIP_NAME = 66256
STARTUP = startup_ht32f5xxxx_gcc_16
TARGET_NAME = HT32
...
C_OPTION += -DUSE_HT32F66256_DVB
C_OPTION += -DUSE_HT32F66256
C_OPTION += -DUSE_MEM_HT32F66256
S_OPTION = --defsym USE_HT32_CHIP=43
...
SOURCE_NAME_PATH += ../system_ht32f5xxxx_16.c
...
$(HT32_LIB_PATH)ht32f65xxx_66xxx_adc.c \
$(HT32_LIB_PATH)ht32f5xxxx_bftm.c \
$(HT32_LIB_PATH)ht32f5xxxx_can.c \
$(HT32_LIB_PATH)ht32f5xxxx_ckcu.c \
$(HT32_LIB_PATH)ht32f5xxxx_cmp.c \
$(HT32_LIB_PATH)ht32f66xxx_cordic.c \
...
$(HT32_LIB_PATH)ht32f65xxx_66xxx_pga.c \
$(HT32_LIB_PATH)ht32f66xxx_pid.c \
