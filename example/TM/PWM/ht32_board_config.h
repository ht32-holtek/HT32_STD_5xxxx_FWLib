...
#define  HTCFG_PWM_TM_PCLK                       (LIBCFG_MAX_SPEED)
  ...
  #define  HTCFG_PWM0_CHN                         0
  #define  HTCFG_PWM0_GPIOX                       A               // A8/D30
  #define  HTCFG_PWM0_GPION                       0

  #define  HTCFG_PWM1_CHN                         1
  #define  HTCFG_PWM1_GPIOX                       A               // A0/D14
  #define  HTCFG_PWM1_GPION                       1

  #define  HTCFG_PWM2_CHN                         2
  #define  HTCFG_PWM2_GPIOX                       A               // A1/D15
  #define  HTCFG_PWM2_GPION                       2

  #define  HTCFG_PWM3_CHN                         3
  #define  HTCFG_PWM3_GPIOX                       A               // A2/D16
  #define  HTCFG_PWM3_GPION                       3
#endif
  ...
  #define  HTCFG_PWM0_CHN                         0
  #define  HTCFG_PWM0_GPIOX                       B               // PIN W
  #define  HTCFG_PWM0_GPION                       8

  #define  HTCFG_PWM1_CHN                         1
  #define  HTCFG_PWM1_GPIOX                       B               // PIN V
  #define  HTCFG_PWM1_GPION                       7

  #define  HTCFG_PWM2_CHN                         2
  #define  HTCFG_PWM2_GPIOX                       B               // PIN U
  #define  HTCFG_PWM2_GPION                       6

  #define  HTCFG_PWM3_CHN                         3
  #define  HTCFG_PWM3_GPIOX                       C               // PIN NP
  #define  HTCFG_PWM3_GPION                       3
#endif
