...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define HTCFG_OUTPUT_LED1_AFIO_PIN                            (AFIO_PIN_5)
  #define HTCFG_OUTPUT_LED2_AFIO_PIN                            (AFIO_PIN_1)
  #define HTCFG_INPUT_WAKE_AFIO_PIN                             (AFIO_PIN_9)
  #define HTCFG_INPUT_KEY1_AFIO_PIN                             (AFIO_PIN_3)

  #define HTCFG_OUTPUT_LED1_GPIO_PIN                            (GPIO_PIN_5)
  #define HTCFG_OUTPUT_LED2_GPIO_PIN                            (GPIO_PIN_1)
  #define HTCFG_INPUT_WAKE_GPIO_PIN                             (GPIO_PIN_9)
  #define HTCFG_INPUT_KEY1_GPIO_PIN                             (GPIO_PIN_3)
#endif
  ...
  #define HTCFG_OUTPUT_LED1_ID                                  (GPIO_PC)               // D13
  #define HTCFG_OUTPUT_LED2_ID                                  (GPIO_PA)               // A0/D14
  #define HTCFG_INPUT_WAKE_ID                                   (GPIO_PA)               // A3/D17
  #define HTCFG_INPUT_KEY1_ID                                   (GPIO_PA)               // A6/D31
  ...
  #define HTCFG_OUTPUT_LED1_AFIO_PIN                            (AFIO_PIN_2)
  #define HTCFG_OUTPUT_LED2_AFIO_PIN                            (AFIO_PIN_1)
  #define HTCFG_INPUT_WAKE_AFIO_PIN                             (AFIO_PIN_4)
  #define HTCFG_INPUT_KEY1_AFIO_PIN                             (AFIO_PIN_5)

  #define HTCFG_OUTPUT_LED1_GPIO_PIN                            (GPIO_PIN_2)
  #define HTCFG_OUTPUT_LED2_GPIO_PIN                            (GPIO_PIN_1)
  #define HTCFG_INPUT_WAKE_GPIO_PIN                             (GPIO_PIN_4)
  ...
  #define HTCFG_OUTPUT_LED1_AFIO_PIN                            (AFIO_PIN_0)
  #define HTCFG_OUTPUT_LED2_AFIO_PIN                            (AFIO_PIN_1)
  #define HTCFG_INPUT_WAKE_AFIO_PIN                             (AFIO_PIN_2)
  #define HTCFG_INPUT_KEY1_AFIO_PIN                             (AFIO_PIN_3)
