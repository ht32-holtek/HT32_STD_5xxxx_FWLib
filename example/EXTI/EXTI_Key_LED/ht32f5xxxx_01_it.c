...
{
  #if defined(USE_HT32F65240_DVB) || defined(USE_HT32F65240_SK) || defined(USE_HT32F50030_SK) || defined(USE_HT32F66242_DVB) || defined(USE_HT32F66246_DVB) || defined(USE_HT32F65233_DVB)
  #else
  WAKEUP_Button_Process();
  #endif
