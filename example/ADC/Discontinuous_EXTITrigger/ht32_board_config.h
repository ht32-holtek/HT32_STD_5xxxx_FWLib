...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_KEY1_GPIOX                       A               // D31
  #define _HTCFG_KEY1_GPION                       5

  #define _HTCFG_VR_GPIOX                         A               // A2/D16
  #define _HTCFG_VR_GPION                         3
  #define _HTCFG_VR_ADC_CHN                       3

  #define _HTCFG_AD2_GPIOX                        C               // A4/D18
  #define _HTCFG_AD2_GPION                        5
  #define _HTCFG_AD2_ADC_CHN                      11

  #define _HTCFG_AD3_GPIOX                        C               // A5/D19
  #define _HTCFG_AD3_GPION                        4
  #define _HTCFG_AD3_ADC_CHN                      10
#endif
