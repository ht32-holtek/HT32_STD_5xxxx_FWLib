...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_MCTM_BREAK_GPIOX                      B                       // D6
  ...
  #define _HTCFG_MCTM_BREAK_GPIOX                      C
  ...
  #define  HTCFG_MCTM_CH2_AFIO_PIN                     (AFIO_PIN_15)
  #define  HTCFG_MCTM_CH2N_AFIO_PIN                    (AFIO_PIN_14)
  #define  HTCFG_MCTM_BREAK_AFIO_PIN                   (AFIO_PIN_10)
  ...
  #define  HTCFG_MCTM_CH0_AFIO_PIN                     (AFIO_PIN_1)
  #define  HTCFG_MCTM_CH0N_AFIO_PIN                    (AFIO_PIN_2)
  #define  HTCFG_MCTM_CH1_AFIO_PIN                     (AFIO_PIN_7)
  #define  HTCFG_MCTM_CH1N_AFIO_PIN                    (AFIO_PIN_8)
  #define  HTCFG_MCTM_CH2_AFIO_PIN                     (AFIO_PIN_2)
  #define  HTCFG_MCTM_CH2N_AFIO_PIN                    (AFIO_PIN_3)
  #define  HTCFG_MCTM_BREAK_AFIO_PIN                   (AFIO_PIN_3)
  ...
  #define  HTCFG_MCTM_CH0_AFIO_PIN                     (AFIO_PIN_9)
  #define  HTCFG_MCTM_CH0N_AFIO_PIN                    (AFIO_PIN_8)
  #define  HTCFG_MCTM_CH1_AFIO_PIN                     (AFIO_PIN_1)
  #define  HTCFG_MCTM_CH1N_AFIO_PIN                    (AFIO_PIN_0)
  #define  HTCFG_MCTM_CH2_AFIO_PIN                     (AFIO_PIN_15)
  #define  HTCFG_MCTM_CH2N_AFIO_PIN                    (AFIO_PIN_14)
