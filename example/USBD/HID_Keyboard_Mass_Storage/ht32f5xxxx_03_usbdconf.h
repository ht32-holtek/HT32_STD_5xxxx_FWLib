/*********************************************************************************************************//**
 * @file    USBD/HID_Keyboard_Mass_Storage/ht32f5xxxx_03_usbdconf.h
 * @version $Rev:: 9625         $
...
#ifndef __HT32F5XXXX_03_USBDCONF_H
#define __HT32F5XXXX_03_USBDCONF_H
...
//    <o0.18> Endpoint10 Interrupt Enable (EP10IE)
//    <o0.19> Endpoint11 Interrupt Enable (EP11IE)
//    <o0.20> Endpoint12 Interrupt Enable (EP12IE)
#define _UIER               (0x0F1D)
//  </h>
...
/*----------------------------------------------------------------------------------------------------------*/
/* Endpoint10 Configuration Setting                                                                          */
/*----------------------------------------------------------------------------------------------------------*/
//  <e0> Endpoint10 Configuration
#define _EP10_ENABLE         (0)
...
//      <11=> 11
//      <12=> 12
#define _EP10_CFG_EPADR      (10)

//    <o0.0> Endpoint Enable (EPEN)
#define _EP10_CFG_EPEN_TMP   (1)
...
//      <1=> IN
//      <0=> OUT
#define _EP10_CFG_EPDIR      (1)

//    <o0> Endpoint Buffer Length (EPLEN) (in byte) <4-64:4>
                            /* Maximum: 64 Bytes                                                            */
#define _EP10LEN_TMP         (8)
...
//      <o0.6> STALL Transmitted Interrupt Enable (STLIE)
//      <o0.7> USB Error Interrupt Enable (UERIE)
#define _EP10_IER            (0x10)
// </h>
// </e>

/*----------------------------------------------------------------------------------------------------------*/
/* Endpoint11 Configuration Setting                                                                          */
/*----------------------------------------------------------------------------------------------------------*/
//  <e0> Endpoint11 Configuration
#define _EP11_ENABLE         (0)
...
//      <11=> 11
//      <12=> 12
#define _EP11_CFG_EPADR      (11)

//    <o0.0> Endpoint Enable (EPEN)
#define _EP11_CFG_EPEN_TMP   (1)
...
//      <1=> IN
//      <0=> OUT
#define _EP11_CFG_EPDIR      (1)

//    <o0> Endpoint Buffer Length (EPLEN) (in byte) <4-64:4>
                            /* Maximum: 64 Bytes                                                            */
#define _EP11LEN_TMP         (8)
...
//      <o0.6> STALL Transmitted Interrupt Enable (STLIE)
//      <o0.7> USB Error Interrupt Enable (UERIE)
#define _EP11_IER            (0x10)
// </h>
// </e>

/*----------------------------------------------------------------------------------------------------------*/
/* Endpoint12 Configuration Setting                                                                          */
/*----------------------------------------------------------------------------------------------------------*/
//  <e0> Endpoint12 Configuration
#define _EP12_ENABLE         (0)
...
//      <11=> 11
//      <12=> 12
#define _EP12_CFG_EPADR      (12)

//    <o0.0> Endpoint Enable (EPEN)
#define _EP12_CFG_EPEN_TMP   (1)
...
//      <1=> IN
//      <0=> OUT
#define _EP12_CFG_EPDIR      (1)

//    <o0> Endpoint Buffer Length (EPLEN) (in byte) <4-64:4>
                            /* Maximum: 64 Bytes                                                            */
#define _EP12LEN_TMP         (8)
