/*********************************************************************************************************//**
 * @file    CAN/Send_Recv_DATA/ht32_can_config.h
...
#define HTCFG_CAN_CF0_MENU_BAUDRATE               (500000)

//   <o> -- CAN Baudrate Manual Input  <1-1000000>
//   <i> Only used when CAN Baudrate is set to Manual Input
...
#else
  #define HTCFG_CAN_CF0_BAUDRATE HTCFG_CAN_CF0_MENU_BAUDRATE
#endif
