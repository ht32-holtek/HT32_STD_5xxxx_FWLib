...
/** @addtogroup Recv_BasicMode
  * @{
  */

void CAN_ResetIF(HT_CAN_TypeDef *CANx);
/* Settings ------------------------------------------------------------------------------------------------*/
...
void CAN_Configuration(void)
{
...

  {
    ...
    */
    ...
    CAN_InitStruct.CAN_Mode        = CAN_MODE_BASIC;
...
void CAN_MsgInit(void)
{
  ...
  // gRxMsg.IdMask    = 0x1FFFFFFF; /* In basic mode the ID mask functionis turned off                      */
  gRxMsg.IdType    = CAN_STD_ID;
