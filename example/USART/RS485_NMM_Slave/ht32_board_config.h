...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_UART_RTS_GPIOX                   A               // D3
  #define _HTCFG_UART_RTS_GPION                   14
  #define HTCFG_UART_IPN                          USART0
  #define HTCFG_HSI_AUTO_TRIM_BY_LSE                              // ENABLE
#endif
  ...
  #define _HTCFG_UART_TX_GPION                    12
  ...
  #define _HTCFG_UART_TX_GPIOX                    B
  #define _HTCFG_UART_TX_GPION                    10
  #define _HTCFG_UART_RX_GPIOX                    B
  #define _HTCFG_UART_RX_GPION                    9
  #define _HTCFG_UART_RTS_GPIOX                   C
