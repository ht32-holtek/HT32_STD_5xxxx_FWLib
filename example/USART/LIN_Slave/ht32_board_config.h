...
/* Settings ------------------------------------------------------------------------------------------------*/
  ...
  #define _HTCFG_UART_TX_GPION                    6
  #define _HTCFG_UART_RX_GPIOX                    C
  #define _HTCFG_UART_RX_GPION                    7
  ...
  #define LIN_FORCR_UART_MODE                     (0) // Set as 1 to force the UART mode (did not use hardware LIN mode)
  #define HTCFG_IPSEL                             0 /* Select BFTM0                                         */
#endif
  ...
  #define _HTCFG_UART_TX_GPIOX                    A
  #define _HTCFG_UART_TX_GPION                    5
  #define _HTCFG_UART_RX_GPIOX                    B
  #define _HTCFG_UART_RX_GPION                    8
  #define HTCFG_UART_IPN                          UART0
  #define HTCFG_IPSEL                             0 /* Select BFTM0                                         */
#endif
