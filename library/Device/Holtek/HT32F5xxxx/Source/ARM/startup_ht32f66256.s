...
;//      <33=> HT32F66242
;//      <43=> HT32F66256
USE_HT32_CHIP_SET   EQU     43 ; Notice that the project's Asm Define has the higher priority.
...
Default_Handler     PROC
                    ...
                    EXPORT  MCTM0_1_BRK_IRQHandler          [WEAK]
                    EXPORT  MCTM0_1_UP_IRQHandler           [WEAK]
                    EXPORT  MCTM0_1_TR_UP2_IRQHandler       [WEAK]
                    EXPORT  MCTM0_1_CC_IRQHandler           [WEAK]
                    EXPORT  GPTM0_G_IRQHandler              [WEAK]
                    EXPORT  GPTM0_VCLK_IRQHandler           [WEAK]
                    EXPORT  GPTM0_1_VCLK_IRQHandler         [WEAK]
                    EXPORT  BFTM0_IRQHandler                [WEAK]
                    EXPORT  BFTM1_IRQHandler                [WEAK]
                    EXPORT  BFTM1_2_IRQHandler              [WEAK]
                    EXPORT  CMP0_IRQHandler                 [WEAK]
                    EXPORT  CMP1_IRQHandler                 [WEAK]
                    EXPORT  CMP0_1_IRQHandler               [WEAK]
                    EXPORT  CMP2_3_IRQHandler               [WEAK]
                    EXPORT  PID0_IRQHandler                 [WEAK]
                    EXPORT  I2C0_IRQHandler                 [WEAK]
                    EXPORT  SPI0_IRQHandler                 [WEAK]
                    EXPORT  I2C0_1_IRQHandler               [WEAK]
                    EXPORT  SPI0_1_IRQHandler               [WEAK]
                    EXPORT  USART0_IRQHandler               [WEAK]
                    EXPORT  UART0_IRQHandler                [WEAK]
                    EXPORT  UART0_1_IRQHandler              [WEAK]
                    EXPORT  PDMA_CH0_1_IRQHandler           [WEAK]
                    EXPORT  PDMA_CH2_3_IRQHandler           [WEAK]
                    EXPORT  PDMA_CH4_5_IRQHandler           [WEAK]
                    EXPORT  GPTM1_G_IRQHandler              [WEAK]
                    EXPORT  PDMA_CH0_2_IRQHandler           [WEAK]
                    EXPORT  PDMA_CH3_5_IRQHandler           [WEAK]
