...
#define IS_CMP_InputSelection(x)                  ((x == CMP_INPUT_CMP0P)  || \
                                                   ...
                                                   (x == CMP_INPUT_PGA2O)  || \
                                                   (x == CMP_INPUT_PGA3O))
#elif (LIBCFG_CMP_POS_INPUT_SEL_V4)
#define CMP_INPUT_CMP0P                           ((u32)0x00000000)
#define CMP_INPUT_PGA1O                           ((u32)0x00000002)
#define CMP_INPUT_OPA0O                           ((u32)0x00000003)
#define CMP_INPUT_CMP1P0                          ((u32)0x00000000)
#define CMP_INPUT_CMP1P1                          ((u32)0x00000001)
#define CMP_INPUT_CMP1P2                          ((u32)0x00000002)
#define CMP_INPUT_PGA0O                           ((u32)0x00000010)
