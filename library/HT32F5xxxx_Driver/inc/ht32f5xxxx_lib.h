...
/* Settings ------------------------------------------------------------------------------------------------*/
#define HT32_FWLIB_VER                  (0x01018001)
#define HT32_FWLIB_SVN                  (0x9404)
...
#if _OPA && LIBCFG_OPA
  #if defined(USE_HT32F65230_40) || defined(USE_HT32F65232) || defined(USE_HT32F65233)
