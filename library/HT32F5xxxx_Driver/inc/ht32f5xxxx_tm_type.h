...
#ifndef __HT32F5XXXX_TM_TYPE_H
#define __HT32F5XXXX_TM_TYPE_H
...
typedef enum
{
  ...
  TM_CH_4,                        /*!< TM channel 4                                                         */
  TM_CH_5,                        /*!< TM channel 5                                                         */
  TM_CH_6,                        /*!< TM channel 6                                                         */
  TM_CH_7,                        /*!< TM channel 7                                                         */
#endif
} TM_CH_Enum;
/**
...
typedef enum
{
  MCTM_UEV1UD = 0x00000004,                 /*!< MCTM update event 1 rquest by overflow disable control     */
  MCTM_UEV1OD = 0x00000008,                 /*!< MCTM update event 1 rquest by underflow disable control    */
} MCTM_UEV1DIS_Enum;
#endif
/**
  * @}
