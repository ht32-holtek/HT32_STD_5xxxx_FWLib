...
#endif
#if ((LIBCFG_CMP) && (LIBCFG_OPA) && (LIBCFG_PGA))
#define AFIO_FUN_CMP        AFIO_MODE_3        /*!< AFIO mode CMP                                           */
#define AFIO_FUN_OPA        AFIO_FUN_OPA_PGA   /*!< AFIO mode OPA                                           */
#define AFIO_FUN_PGA        AFIO_FUN_OPA_PGA   /*!< AFIO mode PGA                                           */
...
#if ((LIBCFG_CMP) && (LIBCFG_OPA) && (LIBCFG_PGA))
#define AFIO_FUN_OPA_PGA    AFIO_MODE_8        /*!< AFIO mode OPA/PGA                                       */
#elif ((LIBCFG_CMP) && (LIBCFG_OPA))
...
#define AFIO_FUN_MCTM_MOD1  AFIO_MODE_13       /*!< AFIO mode MCTM Mode1                                    */
#define AFIO_FUN_MCTM_MOD2  AFIO_MODE_14       /*!< AFIO mode MCTM Mode2                                    */
#define AFIO_FUN_MCTM_SYSTEM  AFIO_MODE_15     /*!< AFIO mode MCTM/System                                   */
